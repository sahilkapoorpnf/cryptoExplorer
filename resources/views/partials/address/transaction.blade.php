<div class="mt-4">
    <div>
        ...
        <a class="transaction-link" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(), asset(Helper::network(). '/transactions/'. $transaction->txid)) }}">
            {{ $transaction->txid }}   
        </a>
    </div>
